...
// Growth/MoraleTop 順序對應 C 版最後四欄:(dwelling, growth_num, morale_cap, morale_group)。
func troopTable() []Troop {
	return []Troop{
		...
		{Name: "農夫", SkillLevel: 1, HP: 1, Move: 1, MeleeMin: 1, MeleeMax: 1,
			...
			Home: DwellPlains, Growth: 250, MoraleTop: 6, MoraleGroup: 0},
		// 1: 小妖精
		{Name: "小妖精", SkillLevel: 1, HP: 1, Move: 1, MeleeMin: 1, MeleeMax: 2,
			...
			Home: DwellForest, Growth: 200, MoraleTop: 6, MoraleGroup: 2},
		// 2: 義勇軍
		{Name: "義勇軍", SkillLevel: 2, HP: 2, Move: 2, MeleeMin: 1, MeleeMax: 2,
			...
			Home: DwellCastle, Growth: 0, MoraleTop: 5, MoraleGroup: 0},
		// 3: 野狼
		{Name: "野狼", SkillLevel: 2, HP: 3, Move: 3, MeleeMin: 1, MeleeMax: 3,
			...
			Home: DwellPlains, Growth: 150, MoraleTop: 5, MoraleGroup: 3},
		// 4: 骷髏兵
		{Name: "骷髏兵", SkillLevel: 2, HP: 3, Move: 2, MeleeMin: 1, MeleeMax: 2,
			...
			Home: DwellDungeon, Growth: 150, MoraleTop: 5, MoraleGroup: 4},
		// 5: 僵屍
		{Name: "僵屍", SkillLevel: 2, HP: 5, Move: 1, MeleeMin: 2, MeleeMax: 2,
			...
			Home: DwellDungeon, Growth: 100, MoraleTop: 5, MoraleGroup: 4},
		// 6: 地精
		{Name: "地精", SkillLevel: 2, HP: 5, Move: 1, MeleeMin: 1, MeleeMax: 3,
			...
			Home: DwellForest, Growth: 250, MoraleTop: 5, MoraleGroup: 2},
		// 7: 牛獸人
		{Name: "牛獸人", SkillLevel: 2, HP: 5, Move: 2, MeleeMin: 2, MeleeMax: 3,
			...
			Home: DwellHillCave, Growth: 200, MoraleTop: 5, MoraleGroup: 3},
		// 8: 弓箭手
		{Name: "弓箭手", SkillLevel: 2, HP: 10, Move: 2, MeleeMin: 1, MeleeMax: 2,
			...
			Home: DwellCastle, Growth: 0, MoraleTop: 5, MoraleGroup: 1},
		// 9: 精靈族
		{Name: "精靈族", SkillLevel: 3, HP: 10, Move: 3, MeleeMin: 1, MeleeMax: 2,
			...
			Home: DwellForest, Growth: 100, MoraleTop: 4, MoraleGroup: 2},
		// 10: 槍兵
		{Name: "槍兵", SkillLevel: 3, HP: 10, Move: 2, MeleeMin: 2, MeleeMax: 4,
			...
			Home: DwellCastle, Growth: 0, MoraleTop: 4, MoraleGroup: 1},
		// 11: 流浪者
		{Name: "流浪者", SkillLevel: 3, HP: 15, Move: 2, MeleeMin: 2, MeleeMax: 4,
			...
			Home: DwellPlains, Growth: 150, MoraleTop: 4, MoraleGroup: 2},
		// 12: 矮人
		{Name: "矮人", SkillLevel: 3, HP: 20, Move: 1, MeleeMin: 2, MeleeMax: 4,
			...
			Home: DwellHillCave, Growth: 100, MoraleTop: 4, MoraleGroup: 2},
		// 13: 鬼
		{Name: "鬼", SkillLevel: 4, HP: 10, Move: 3, MeleeMin: 3, MeleeMax: 4,
			...
			Home: DwellDungeon, Growth: 25, MoraleTop: 3, MoraleGroup: 4},
		// 14: 武士
		{Name: "武士", SkillLevel: 5, HP: 35, Move: 1, MeleeMin: 6, MeleeMax: 10,
			...
			Home: DwellCastle, Growth: 250, MoraleTop: 3, MoraleGroup: 1},
		// 15: 食人怪
		{Name: "食人怪", SkillLevel: 4, HP: 40, Move: 1, MeleeMin: 3, MeleeMax: 5,
			...
			Home: DwellHillCave, Growth: 200, MoraleTop: 3, MoraleGroup: 3},
		// 16: 野人
		{Name: "野人", SkillLevel: 4, HP: 40, Move: 3, MeleeMin: 1, MeleeMax: 6,
			RangedMin: 0, RangedMax: 0, RangedShots: 0, GoldCost: 750, Spoils: 75, Abilities: 0,
			Home: DwellPlains, Growth: 100, MoraleTop: 3, MoraleGroup: 2},
		// 17: 洞穴巨人
		{Name: "洞穴巨人", SkillLevel: 4, HP: 50, Move: 1, MeleeMin: 2, MeleeMax: 5,
			...
			Home: DwellForest, Growth: 25, MoraleTop: 3, MoraleGroup: 3},
		// 18: 騎兵
		{Name: "騎兵", SkillLevel: 4, HP: 20, Move: 4, MeleeMin: 3, MeleeMax: 5,
			...
			Home: DwellCastle, Growth: 0, MoraleTop: 2, MoraleGroup: 1},
		// 19: 德魯依
		{Name: "德魯依", SkillLevel: 5, HP: 25, Move: 2, MeleeMin: 2, MeleeMax: 3,
			...
			Home: DwellForest, Growth: 25, MoraleTop: 2, MoraleGroup: 2},
		// 20: 法師
		{Name: "法師", SkillLevel: 5, HP: 25, Move: 1, MeleeMin: 2, MeleeMax: 3,
			...
			Home: DwellPlains, Growth: 25, MoraleTop: 2, MoraleGroup: 2},
		// 21: 吸血鬼
		{Name: "吸血鬼", SkillLevel: 5, HP: 30, Move: 1, MeleeMin: 3, MeleeMax: 6,
			...
			Home: DwellDungeon, Growth: 50, MoraleTop: 2, MoraleGroup: 4},
		// 22: 巨人
		{Name: "巨人", SkillLevel: 5, HP: 60, Move: 3, MeleeMin: 10, MeleeMax: 20,
			...
			Home: DwellHillCave, Growth: 50, MoraleTop: 2, MoraleGroup: 2},
		// 23: 惡魔
		{Name: "惡魔", SkillLevel: 6, HP: 50, Move: 1, MeleeMin: 5, MeleeMax: 7,
			...
			Home: DwellDungeon, Growth: 25, MoraleTop: 1, MoraleGroup: 4},
		// 24: 火龍
		{Name: "火龍", SkillLevel: 6, HP: 200, Move: 1, MeleeMin: 25, MeleeMax: 50,
			...
			Home: DwellHillCave, Growth: 25, MoraleTop: 1, MoraleGroup: 3},
	}
}
